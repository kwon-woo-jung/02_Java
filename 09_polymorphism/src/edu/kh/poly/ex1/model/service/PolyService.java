...
//		car3.setDiscountOffer(0.5);
	...
	public void printCar(Car temp) {
		...
		// Car temp = s
		// 다형성의 업캐스팅 모양과 똑같다
		// -> temp라는 매개변수에는 Tesla, Spark, Car 주소가 넘어와도 된다(업캐스팅)
		System.out.println("엔진 : " temp.getEngine());
		System.out.println("연료 : " + temp.getFuel());
		System.out.println("바퀴 갯수 : " + temp.getFuel() + "개" );
	...
	public void ex3() {
		...
		Car c1 = new Tesla("전기보터", "전기", 4, 50000);
	...
	public void ex4() {
		...
		Spark s1 = (Spark)c1; // c1을 관계없음 Spark로 다운캐스팅하려고함
	...
	public void ex5() {
		...
		// c1.toString() 호출코드와
		// edu.kh.poly.ex1.model.dto.Car.toString() 메소드 코드 연결
		// -> 정적 바인딩
