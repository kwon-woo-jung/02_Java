...
public class ClientService {
	...
	public void clientStart() {
		...
		// serverIP가 현재 코드에서 127.0.0.1로 설정 되어 있는데,
		// localhost로 자기 자신의 컴퓨터에 연결하려면 해당 서버의 IP를 입력해야 합니다.
		...
		InputStream is = null;
		// 서버와 통신을 위해 소켓의 입력 스트림( InputStream)과 출력 스트림과
		OutputStream os = null;
		// (OutputStream)을 열고, 이를 통해 데이터를 주고 받습니다.
