...
public class Member {
	// 속성(필드 == 멤버 변수)
	// 속성(필드 == 멤버 변수)
	private String memberId; //	캡슐화
	private String memberPw; //	캡슐화
	private String memberName; //	캡슐화
	private int memberAge; //	캡슐화
...
//		super(); (super)는 지움
	...
	// 메서드
		// getter/setter {왜 만드나? : 필드에 선선된 멤버변수들이 캡슐화 원칙에 의해서 private으로 만들어짐
		// private은 다른 클래스에서 직접 접근 불가함.
		// 간접 접근 방식으로 값을 세팅/얻어올 수 있어야함.
		// -> 그래서 getter/setter 접근제한자가 public 임.
		// public은 다 접근 가능하고, 언제 어디서든 가져올 수 있음!
	...
	public String getMemberId() {
		...
		// -> 매개변수가 없어서 중복된 이름의 memberId가 없기떄문에 memberId라고만 써도 가능!
	}
