...
public class StudentService {
	...
	//private List<Student> studentList = new LinkedList<Student>(); // 추가, 수정, 삭제의 효율적
	...
	*/
	...
	/**
	 * 1. 학생 정보 추가 메서드
	 * @author 삽입 성공 시 "성공" 실패 시 "실패" 문자열 반환
	 */
	...
	public String addStudent() throws InputMismatchException{
		...
		if( studentList.add(new Student(name, age, region, gender, score)) ) {
			...
			// (반환형)                         -> 제네릭 <Student> 떄문에 List에 추가할 수 있는 객체 타입이
			//								Student로 제한됨
...
public void selectAll() {
	...
	// studentList 비어있는 경우 "학생 정보가 없습니다" 출력
	
	// -List에 저정된 데이터의 개수를 얻어오는 방법 : int List.size();
