...
//	매개변수생성자
	public Student1(String name, int age, String region, char gender, int score) {
		super();
		this.name = name;
		this.age = age;
		this.region = region;
	...
	public String toString() {
		return "Student1 [name=" + name + ", age=" + age + ", region=" + region + ", gender=" + gender + ", score="
				+ score + "]";
	}
	
	/*
	 * @Override pulice int compareTo(Student other) { // compareTo() : 객체를 정렬하기 위해
